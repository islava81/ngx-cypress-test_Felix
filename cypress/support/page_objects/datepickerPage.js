...
function selectDayFromCurrent(day){
    ...
    cy.get('nb-calendar-navigation').invoke('attr', 'ng-reflect-date').then( dateAttribute => {
        if(!dateAttribute.includes(futureMonth)) {
            ...
            //cy.get('nb-calendar-day-picker [class="day-cell ng-star-inserted"]').contains(futureDay).click() //This only
            //works only when the future day is on the next consecutive month in the date picker
